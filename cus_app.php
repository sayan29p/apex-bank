...
<body>
    ...
    <h2 class="text-center pt-4" style="color : black;">APPROVAL LIST</h2>
...
<?php 
 ...
 $sql = "select * from customers where APPROVE='N'";
...
?>   
        ...
        <tr>
        <td><a href=adminapp.php?ACC_NO=".$row["ACC_NO"]><?php echo $rows1['ACC_NO'] ?></a></td>
