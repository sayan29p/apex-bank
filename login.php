...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // echo $app;
     IF($app=='Y')
     {
    $sql1 = "SELECT * FROM `customers` WHERE CUS_ID='$CUS_ID' AND CUS_PASS='$CUS_PASS'";
    ...
    if ($num == 1){
        ...
        echo ' alert("Oops! Not approved")';  // showing an alert box.
        echo '</script>';
    }
}
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container my-4">
     ...
     <form action="/apexbank/login.php" method="post">
        ...
        <a class="btn btn-primary" href="/apexbank/signup.php" role="button">Register</a>
     </form>
